...
@Component({
  selector: 'app-in-out-inventory-warehouse-report',
  templateUrl: './in-out-inventory-warehouse-report.component.html',
  styleUrls: ['./in-out-inventory-warehouse-report.component.css'],
  providers: [DialogService],
})
export class InOutInventoryWarehouseReportComponent implements OnInit {
  ...
  exportExcel() {
    setTimeout(()=>{
      ...
      XLSX.writeFile(wb, 'Báo cáo xuât nhập tồn kho.xlsx')
    },400)
  }
